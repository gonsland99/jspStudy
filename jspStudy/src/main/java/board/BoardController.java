...
public class BoardController extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HttpSession session;
		String action = request.getPathInfo();	//url path
		...
		try {
			...
			if (action==null){	
				...
				pw.print("<script>" + "  alert('새글추가.');" + " location.href='" + request.getContextPath()
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('글 수정.');" + " location.href='" + request.getContextPath()
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('글 삭제.');" + " location.href='" + request.getContextPath()
						+ "/board/listArticles.do';" + "</script>");
				return;
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('답글.');" + " location.href='" + request.getContextPath()
						+ "/board/viewArticle.do?articleNO="+articleNO+"';" + "</script>");
				return;
